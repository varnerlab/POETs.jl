...
% ── Layout: three panels, wider right panel ──
% Left: 4.4cm  |  Center: 5.2cm  |  Right: 7.6cm
% Height: 7.0cm content + title/tagline
...
\node[font=\sffamily\small, text=midgray] at (9.0, 7.4) {%
    Multiobjective parameter ensembles for uncertainty-aware modeling%
};

% ════════════════════════════════════════════
% LEFT: The Problem — Single Best Fit
% ════════════════════════════════════════════
...
% Limitations (clean, no question mark)
\node[anchor=north, text width=3.6cm, align=center, font=\scriptsize, text=darktext]
    at (2.2, 2.65) {%
    How well constrained\\are the parameters?\\[6pt]
    Which predictions\\can we trust?\\[6pt]
    {\footnotesize\itshape\color{midgray} No way to know.}
};
...
\end{scope}
% Axis labels (outside clip, inside panel)
\node[font=\sffamily\scriptsize, text=midgray] at (7.4, 1.1) {$\varepsilon_1$ (Objective 1)};
\node[font=\sffamily\scriptsize, text=midgray, rotate=90] at (4.9, 3.65) {$\varepsilon_2$ (Objective 2)};
% Legend
...
\end{scope}
% Legend line below predictions
\draw[steelblue, line width=1pt] (10.8, 3.85) -- ++(0.35, 0);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (11.22, 3.85) {Mean};
\draw[darktext, line width=0.6pt, dashed] (11.85, 3.85) -- ++(0.35, 0);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (12.27, 3.85) {True};
\fill[steelblue!15] (12.75, 3.78) rectangle ++(0.2, 0.14);
\draw[steelblue!30, line width=0.2pt] (12.75, 3.78) rectangle ++(0.2, 0.14);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (13.02, 3.85) {95\% CI};
\fill[darktext] (13.6, 3.85) circle (1.5pt);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (13.72, 3.85) {Data};
\node[font=\sffamily\tiny\bfseries, text=darktext, anchor=west] at (14.3, 3.85) {Held-out predictions with uncertainty};

% ── Bottom-left: Correlation heatmap ──
\fill[lightgray, rounded corners=3pt] (10.7, 0.3) rectangle (14.0, 3.5);
\draw[midgray!50, line width=0.3pt, rounded corners=3pt] (10.7, 0.3) rectangle (14.0, 3.5);
% 8×8 heatmap
\def\cs{0.24}
\pgfmathsetmacro{\hmox}{10.7 + 0.45}
\pgfmathsetmacro{\hmoy}{0.3 + 0.55}
\foreach \i/\j/\c in {
    0/7/steelblue!85, 1/7/coral!50,    2/7/steelblue!15, 3/7/coral!70,    4/7/steelblue!25, 5/7/coral!20, 6/7/steelblue!10, 7/7/coral!35,
    0/6/coral!50,     1/6/steelblue!85, 2/6/steelblue!40, 3/6/steelblue!10,4/6/coral!40,     5/6/steelblue!15, 6/6/coral!55, 7/6/steelblue!30,
    0/5/steelblue!15, 1/5/steelblue!40, 2/5/steelblue!85, 3/5/coral!55,    4/5/steelblue!45, 5/5/coral!35, 6/5/steelblue!20, 7/5/coral!45,
    0/4/coral!70,     1/4/steelblue!10, 2/4/coral!55,     3/4/steelblue!85,4/4/coral!30,     5/4/steelblue!40, 6/4/coral!60, 7/4/steelblue!15,
    0/3/steelblue!25, 1/3/coral!40,     2/3/steelblue!45, 3/3/coral!30,    4/3/steelblue!85, 5/3/coral!55, 6/3/steelblue!15, 7/3/coral!25,
    0/2/coral!20,     1/2/steelblue!15, 2/2/coral!35,     3/2/steelblue!40,4/2/coral!55,     5/2/steelblue!85, 6/2/coral!40, 7/2/steelblue!35,
    0/1/steelblue!10, 1/1/coral!55,     2/1/steelblue!20, 3/1/coral!60,    4/1/steelblue!15, 5/1/coral!40, 6/1/steelblue!85, 7/1/coral!30,
    0/0/coral!35,     1/0/steelblue!30, 2/0/coral!45,     3/0/steelblue!15,4/0/coral!25,     5/0/steelblue!35, 6/0/coral!30, 7/0/steelblue!85
} {
...
% ── Bottom-right: Clinical predictions ──
\fill[lightgray, rounded corners=3pt] (14.4, 0.3) rectangle (17.7, 3.5);
\draw[midgray!50, line width=0.3pt, rounded corners=3pt] (14.4, 0.3) rectangle (17.7, 3.5);
\begin{scope}[shift={(14.4, 0.3)}, clip]
    \clip (0,0) rectangle (3.3, 3.2);
    % Normal
    \fill[steelblue!10]
...
\end{scope}
% Legend (stacked, top-left of panel)
\draw[steelblue, line width=0.8pt] (14.55, 3.25) -- ++(0.3, 0);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (14.9, 3.25) {Normal};
\draw[amber, line width=0.8pt] (14.55, 3.05) -- ++(0.3, 0);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (14.9, 3.05) {Mild};
\draw[coral, line width=0.8pt] (14.55, 2.85) -- ++(0.3, 0);
\node[font=\sffamily\tiny, text=darktext, anchor=west] at (14.9, 2.85) {Severe};
% Title
